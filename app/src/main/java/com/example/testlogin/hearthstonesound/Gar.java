...
/**
 * Created by testLogin on 26.05.2015.
 */

public class Gar extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m12.ogg");
        m2Sound = loadSound("m7.ogg");
        m3Sound = loadSound("m8.ogg");
        m4Sound = loadSound("m10.ogg");
        m5Sound = loadSound("m9.ogg");
        m6Sound = loadSound("m11.ogg");
