...
/**
 * Created by testLogin on 20.05.2015.
 */
public class Valira extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.valira);
        setTitle("Валира");
        ...
        m1Sound = loadSound("m31.ogg");
        m2Sound = loadSound("m26.ogg");
        m3Sound = loadSound("m27.ogg");
        m4Sound = loadSound("m29.ogg");
        m5Sound = loadSound("m28.ogg");
        m6Sound = loadSound("m30.ogg");
