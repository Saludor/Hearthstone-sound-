 ...
 */
public class Mediv extends ActionBarActivity{
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m73.ogg");
        m2Sound = loadSound("m68.ogg");
        m3Sound = loadSound("m69.ogg");
        m4Sound = loadSound("m71.ogg");
        m5Sound = loadSound("m70.ogg");
        m6Sound = loadSound("m72.ogg");
