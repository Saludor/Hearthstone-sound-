...
public class Anduin extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anduin);
        setTitle("Андуин");
        ...
        m1Sound = loadSound("m43.ogg");
        m2Sound = loadSound("m38.ogg");
        m3Sound = loadSound("m39.ogg");
        m4Sound = loadSound("m41.ogg");
        m5Sound = loadSound("m40.ogg");
        m6Sound = loadSound("m42.ogg");
