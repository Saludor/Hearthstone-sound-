 ...
 */
public class Malf extends ActionBarActivity {
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m55.ogg");
        m2Sound = loadSound("m50.ogg");
        m3Sound = loadSound("m51.ogg");
        m4Sound = loadSound("m53.ogg");
        m5Sound = loadSound("m52.ogg");
        m6Sound = loadSound("m54.ogg");
