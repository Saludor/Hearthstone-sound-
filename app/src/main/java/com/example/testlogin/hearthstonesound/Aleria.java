...
/**
 * Created by testLogin on 22.09.2015.
 */
public class Aleria extends ActionBarActivity {
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aleria);
        setTitle("Аллерия");
        ...
        m1Sound = loadSound("m79.ogg");
        m2Sound = loadSound("m74.ogg");
        m3Sound = loadSound("m75.ogg");
        m4Sound = loadSound("m77.ogg");
        m5Sound = loadSound("m76.ogg");
        m6Sound = loadSound("m78.ogg");
