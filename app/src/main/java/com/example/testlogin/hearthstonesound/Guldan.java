...
/**
 * Created by testLogin on 16.09.2015.
 */
public class Guldan extends ActionBarActivity{
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.guldan);
        setTitle("Гулдан");
        ...
        m1Sound = loadSound("m61.ogg");
        m2Sound = loadSound("m56.ogg");
        m3Sound = loadSound("m57.ogg");
        m4Sound = loadSound("m59.ogg");
        m5Sound = loadSound("m58.ogg");
        m6Sound = loadSound("m60.ogg");
