...
/**
 * Created by testLogin on 19.05.2015.
 */

public class Tral extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m25.ogg");
        m2Sound = loadSound("m20.ogg");
        m3Sound = loadSound("m21.ogg");
        m4Sound = loadSound("m23.ogg");
        m5Sound = loadSound("m22.ogg");
        m6Sound = loadSound("m24.ogg");
