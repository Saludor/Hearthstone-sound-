 ...
 */
public class Uter extends ActionBarActivity {
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m49.ogg");
        m2Sound = loadSound("m44.ogg");
        m3Sound = loadSound("m45.ogg");
        m4Sound = loadSound("m47.ogg");
        m5Sound = loadSound("m46.ogg");
        m6Sound = loadSound("m48.ogg");
