...
public class Rexar extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m37.ogg");
        m2Sound = loadSound("m32.ogg");
        m3Sound = loadSound("m33.ogg");
        m4Sound = loadSound("m35.ogg");
        m5Sound = loadSound("m34.ogg");
        m6Sound = loadSound("m36.ogg");
