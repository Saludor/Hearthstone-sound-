 ...
 */
public class Magni extends ActionBarActivity {
...
private ProgressDialog mProgressDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m1Sound = loadSound("m67.ogg");
        m2Sound = loadSound("m62.ogg");
        m3Sound = loadSound("m63.ogg");
        m4Sound = loadSound("m65.ogg");
        m5Sound = loadSound("m64.ogg");
        m6Sound = loadSound("m66.ogg");
